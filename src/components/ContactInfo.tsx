      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start gap-4 p-6 bg-header-gray rounded-xl hover:bg-header-gray/80 transition-colors">
          ...
          <div>
            ...
            <a href="mailto:sharkwave.infotech@gmail.com" className="text-header-primary hover:text-header-primary-dark transition-colors">
              sharkwave.infotech@gmail.com
            </a>
        ...
        <div className="flex items-start gap-4 p-6 bg-header-gray rounded-xl hover:bg-header-gray/80 transition-colors">
          <div className="flex-shrink-0 w-12 h-12 bg-header-accent/10 rounded-lg flex items-center justify-center">
            <svg className="w-6 h-6 text-header-accent" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex-1">
            <h3 className="font-semibold text-header-text mb-1">Phone / WhatsApp</h3>
            <div className="flex items-center gap-2">
              <a href="tel:+917982332910" className="text-header-primary hover:text-header-primary-dark transition-colors">
                +91 7982332910
              </a>
              <a 
            ...
            <p className="text-sm text-header-text-light mt-1">Mon-Fri 9am-6pm IST</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 p-6 bg-header-gray rounded-xl hover:bg-header-gray/80 transition-colors">
          ...
          <div>
            ...
            <p className="text-header-text-light">
              Blue Sapphire Plaza A-134 Office Building<br />
